<div class="container-fluid">
    ...
    <form id="form_cadastro_pagina" action="{{route('metas.update_img')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" style="width: 100%;">
                <div class="file-upload">
                  ...
                  <div class="file-upload-content" style="display: flex;flex-wrap: wrap;justify-content: center;">
                    <div class="col-md-12 col-sm-12">
                      <img class="file-upload-image" src="{{asset('imagens_meta').'/'.$meta_query->content}}" alt="your image" />
