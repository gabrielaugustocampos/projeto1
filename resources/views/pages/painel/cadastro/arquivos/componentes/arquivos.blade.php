...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Cadastro de Arquivos</h1>
    <form id="form_cadastro_pagina" action="{{route('arquivos.store')}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="row" style="display: flex;flex-direction: row;justify-content: center;">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user" name="titulo" placeholder="Titulo do arquivo">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="exampleFormControlSelect1">Descrição</label>
            <input type="text" class="form-control form-control-user" name="descricao" placeholder="Descrição do arquivo">
          </div>
        </div>
        ...
        <div class="form-group" style="width: 100%;" id="arquivo">
            ...
            <div class="file-upload">
              ...
              <input id="input_upload_arquivo" style="display:none;" type='file' name="arquivo" accept="application/pdf">
              ...
              <div class="file-upload-content" style="display: none;flex-wrap: wrap;">
                ...
                <div class="align_btn_img">
                  <div class="col-md-12 col-sm-12">
                    <div class="image-title-wrap">
                      <button type="button" onclick="alterarUpload_arquivo()" class="btn btn-primary"><i class="fas fa-image"></i></button>
                    </div>
                  </div>
                </div>
